...
# Install git hooks from LLVM source into the .git/hooks/ directory.
# This currently only works for the monorepo and in-tree subprojects.
macro(install_git_hooks abspath)
  set(precommit_hook "${CMAKE_SOURCE_DIR}/utils/git/pre-commit")
  if(EXISTS ${precommit_hook})
    unset(hooks_dir)
    ...
    # Use a heuristic to find the .git directory, if we can't rely on git.
    if(NOT hooks_dir)
      if(IS_DIRECTORY "${abspath}/.git")
        set(hooks_dir "${abspath}/.git/hooks")
      elseif(IS_DIRECTORY "${abspath}/../.git")
        set(hooks_dir "${abspath}/../.git/hooks")
      endif()
    endif()
    if((hooks_dir) AND IS_DIRECTORY "${hooks_dir}")
      file(COPY ${precommit_hook} DESTINATION ${hooks_dir} PATTERN ${precommit_hook}
        PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
    endif()
  else()
    message(WARNING "Missing ${precommit_hook}")
  endif()
endmacro()
...
function(add_llvm_subdirectory project type name)
  ...
  if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${add_llvm_external_dir}/CMakeLists.txt)
    ...
    install_git_hooks(${CMAKE_CURRENT_SOURCE_DIR}/${add_llvm_external_dir})
  else()
