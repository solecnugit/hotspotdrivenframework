...
if(LLVM_USE_SANITIZER)
  if (LLVM_ON_UNIX)
    if (LLVM_USE_SANITIZER STREQUAL "Address")
      ...
      # _FORTIFY_SOURCE causes false positives; see https://github.com/google/sanitizers/wiki/AddressSanitizer#faq.
      append("-fsanitize=address -fsanitize-recover=address -U_FORTIFY_SOURCE" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
      append("-Wl,--stub-group-size=0x4000000" CMAKE_EXE_LINKER_FLAGS CMAKE_MODULE_LINKER_FLAGS CMAKE_SHARED_LINKER_FLAGS)
    ...
    elseif (LLVM_USE_SANITIZER STREQUAL "Address;Undefined" OR
      ...
      append_common_sanitizer_flags()
      append("-fsanitize=address -U_FORTIFY_SOURCE" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
      append("-Wl,--stub-group-size=0x4000000" CMAKE_EXE_LINKER_FLAGS CMAKE_MODULE_LINKER_FLAGS CMAKE_SHARED_LINKER_FLAGS)
      append("${LLVM_UBSAN_FLAGS}" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
